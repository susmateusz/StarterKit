...
public class GamePanel extends JPanel {
	...
	private Set<Integer[]> mouseShadow = new HashSet<Integer[]>();
	...
	public void paintComponent(Graphics g) {
		...
		for (List<Integer> cell : dying)
			g.fillRect(cell.get(1) * GOLSwingView.CELL_SIZE, cell.get(0) * GOLSwingView.CELL_SIZE,
					GOLSwingView.CELL_SIZE - 2, GOLSwingView.CELL_SIZE - 2);
		// mouse shadow cells
		g.setColor(mouseShadowCellColor);
		for (Integer[] cell : mouseShadow) {
			cell[0] = ((cell[0] % bounds.get(0) + bounds.get(0)) % bounds.get(0));
			cell[1] = ((cell[1] % bounds.get(1) + bounds.get(1)) % bounds.get(1));
			g.fillRect(cell[1] * GOLSwingView.CELL_SIZE, cell[0] * GOLSwingView.CELL_SIZE, GOLSwingView.CELL_SIZE - 2,
	...
	public void setShadow(Set<Integer[]> points) {
		mouseShadow = points;
	}
